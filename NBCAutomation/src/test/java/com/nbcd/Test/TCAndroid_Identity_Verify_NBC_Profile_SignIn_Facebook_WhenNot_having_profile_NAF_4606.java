...
public class TCAndroid_Identity_Verify_NBC_Profile_SignIn_Facebook_WhenNot_having_profile_NAF_4606 extends GetWebDriverInstance 
{
	...
	@Test(groups="TCAppNBCSignUP")
	 ...
	 public void android_Verify_NBCSignUP() throws Throwable
	 {
		...
		PGNbcProfile objHP = new PGNbcProfile(driver);
			...
			objHP.android_NBC_Profile_With_Facebook_NAF_4606();
